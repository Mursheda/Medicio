...
try
{
	...
	String Query = "Insert into DoctorsMaster(DoctorName,DateOfJoin,Designation,PhoneNumber,Experience,HolidayinWeek,WorkingHours,ChargesPerHour) values(\'"+DoctorName+"\',\'"+strDateOfJoin+"\',\'"+Designation+"\',\'"+PhoneNumber+"\',"+Experience+",\'"+HolidayinWeek+"\',\'"+WorkingHours+"\',"+ChargesPerHour+")";
