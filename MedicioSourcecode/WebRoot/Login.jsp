...
<form role="form" class="lead" action="makeappoint.jsp" method="post">
										<div class="row">
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="dname" id="last_name" class="form-control input-md">
												</div>
											</div>
										</div>
										...
										<p class="lead-footer">* We'll contact you by phone later</p>
