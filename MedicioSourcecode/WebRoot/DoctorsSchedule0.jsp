...
%>	
<H2 align =center> Doctors Schedule</H2>
  ...
  <FORM NAME="DoctorForm" onSubmit="return check()" action="DoctorsSchedule1.jsp">
   ...
   <TABLE BORDER="0" CELLSPACING="2"  CELLPADDING="2" >
	   ...
	   <TR class=row_even >
	   <TD>DoctorName *</TD>
	   <TD><INPUT TYPE="TEXT" NAME="DoctorName" SIZE="10" ></TD><td><input type="button" value="List Doctors" onclick="fnEmpPopUp('ListDoctors.jsp',300,300)"></TD>
	   </TR>
