...
<h2 align=Center>Discharges List</h2>
<form name=cons>
...
<!--	<DIV STYLE="overflow:scroll;width:650px; height:400px;">-->
	...
	<th class=row_title><a class=title href="ViewDischarges.jsp?orderby=PatientID">PatientID</a></th>
...
int DisRow=0;
	...
	while(rs.next())
	{
	  ...
	  DateOfAdmission=rs.getString(7);
	  DateOfDischarge=rs.getString(8);
	  RoomID=rs.getInt(9);
