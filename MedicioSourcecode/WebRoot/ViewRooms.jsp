...
<!--	<DIV STYLE="overflow:scroll;width:650px; height:400px;">-->
	...
	<tr class=row_title>
    <th class=row_title><a class=title href="ViewRooms.jsp?orderby=RoomID">RoomID</a></th>
	<th class=row_title><a class=title href="ViewRooms.jsp?orderby=Category">Category</a></th>
	<th class=row_title><a class=title href="ViewRooms.jsp?orderby=NoOfBeds">NoOfBeds</a></th>
	<th class=row_title><a class=title href="ViewRooms.jsp?orderby=ChargesPerDay">ChargesPerDay</a></th>
	<th class=row_title><a class=title href="ViewRooms.jsp?orderby=VisitorsAllowed">VisitorsAllowed</a></th>
	<th class=row_title><a class=title href="ViewRooms.jsp?orderby=VisitingHours">VisitingHours</a></th>
...
int DisRow=0;
	...
	<tr class= <%=(DisRow%2!=0)? "row_even" : "row_odd"%>>
		...
		<td align=center><%= NoOfBeds%></td>
		<td align=center><%= ChargesPerDay%></td>
		<td align=center><%= VisitorsAllowed%></td>
		<td align=center><%= VisitingHours%></td>
