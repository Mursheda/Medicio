...
try
{
	...
	String Query = "Insert into PatientsMaster(NameOfPatient,Age,Sex,Occupation,ContactNumbers,Natureofillness,DateOfAdmission,AdmissionAs,Insurance,GaurdianName,RelationWithPatient,ReferedByDoctor,RoomID) values(\'"+NameOfPatient+"\',"+Age+",\'"+Sex+"\',\'"+Occupation+"\',\'"+ContactNumbers+"\',\'"+Natureofillness+"\',\'"+strDateOfAdmission+"\',\'"+AdmissionAs+"\',\'"+Insurance+"\',\'"+GaurdianName+"\',\'"+RelationWithPatient+"\',\'"+ReferedByDoctor+"\',"+RoomID+")";
	...
	if(rowsAffected==1)
	{		
			String Query0 = "Insert into InPatientMaster (NameOfPatient,Natureofillness,DateOfAdmission,ReferedByDoctor,RoomID ) values (\'"+NameOfPatient+"\', \'"+Natureofillness+"\',\'"+strDateOfAdmission+"\',\'"+ReferedByDoctor+"\',\'"+RoomID+"\')";
		...
		%>
			<jsp:forward page="Insurance0.jsp">
				...
				<jsp:param name="DateOfAdmission" value="<%=strDateOfAdmission%>"/>
