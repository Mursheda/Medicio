...
System.out.println("ins"+Insurance);
	try{
			...
			String Query = "Insert into billingmaster (NameOfPatient,AdmissionFee,PeriodofStayinHospital,RoomID,RoomRent,ReferedByDoctor,DoctorFee,TotalCharge)values('"+NameOfPatient+"',"+AdmissionFee+","+PeriodofStayinHospital+","+RoomID+","+RoomRent+",'"+ReferedByDoctor+"',"+DoctorFee+","+TotalCharge+")";
