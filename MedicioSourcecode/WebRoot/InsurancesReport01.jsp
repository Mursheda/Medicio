...
<!--	<DIV STYLE="overflow:scroll;width:650px; height:400px;">-->
	...
	<tr class=row_title>
	<th class=row_title><a class=title href="InsurancesReport01.jsp?orderby=NameOfPatient">NameOfPatient</a></th>
	<th class=row_title><a class=title href="InsurancesReport01.jsp?orderby=NameOfApplicant">NameOfApplicant</a></th>
    <th class=row_title><a class=title href="InsurancesReport01.jsp?orderby=WorkingAtCompany">WorkingAtCompany</a></th>
	<th class=row_title><a class=title href="InsurancesReport01.jsp?orderby=RelationWithPatient">RelationWithPatient</a></th>
	<th class=row_title><a class=title href="InsurancesReport01.jsp?orderby=Natureofillness">Nature of illness</a></th>
	<th class=row_title><a class=title href="InsurancesReport01.jsp?orderby=AmountClaimed">AmountClaimed</a></th>
	<th class=row_title><a class=title href="InsurancesReport01.jsp?orderby=Place">Place</a></th>
	<th class=row_title><a class=title href="InsurancesReport01.jsp?orderby=PolicyNumber">PolicyNumber</a></th>
	<th class=row_title><a class=title href="InsurancesReport01.jsp?orderby=ClaimNumber">ClaimNumber</a></th>
<%
