...
//int NoDays = (DateOfDischarge.getTime() -  DateOfAdmission.getTime())/(1000*60*60*24); 
...
try
{
	...
	String Query = "Insert into InsuranceMaster values(\'"+NameOfPatient+"\',\'"+NameOfApplicant+"\',\'"+WorkingAtCompany+"\',\'"+EmployeeID+"\',\'"+RelationWithPatient+"\',\'"+PatientOccupation+"\',\'"+Natureofillness+"\',\'"+DateOfAdmission+"\',\'"+DateOfDischarge+"\',\'"+PeriodofStayinHospital+"\',"+AmountClaimed+",\'"+Place+"\',\'"+PolicyNumber+"\',\'"+ClaimNumber+"\')";
