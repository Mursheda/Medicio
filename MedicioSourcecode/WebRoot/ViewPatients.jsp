...
<!--	<DIV STYLE="overflow:scroll;width:650px; height:400px;">-->
	...
	<th class=row_title><a class=title href="ViewPatients.jsp?orderby=PatientID">PatientID</a></th>
	...
	<th class=row_title><a class=title href="ViewPatients.jsp?orderby=RoomID">RoomID</a></th>
<%
int DisRow=0;
	...
	<tr class= <%=(DisRow%2!=0)? "row_even" : "row_odd"%>>
		...
		<td align=center><%= ContactNumbers%></td>
		<td align=center><%= Natureofillness%></td>
		<td align=center><%= DateOfAdmission%></td>
		<td align=center><%= AdmissionAs%></td>
		<td align=center><%= MediAssist%></td>
		<td align=center><%= GaurdianName%></td>
